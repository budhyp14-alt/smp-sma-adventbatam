...
export default function BimbelEskulPage() {
  // DATA BIMBEL (Ada 5, akan dirender maksimal 4)
  const bimbels = [
    {
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-8 flex flex-col space-y-16">
            ...
            <div className="flex flex-col space-y-10">
              ...
              {/* TOMBOL VIEW MORE ESKUL (Opsional jika ada tambahan nanti) */}
              <div className="pt-2 border-t border-slate-400/30">
                <Link href="/bimbel-eskul/all-eskul" className="bg-[#D97706] hover:bg-amber-700 text-white font-bold text-xs py-2.5 px-6 rounded shadow-sm transition-colors inline-block">
                  View More Eskul →
                </Link>
              </div>
            </div>
